...
public class TextWithColorDrawFormat<T> implements IDrawFormat<T> {
    ...
    public TextWithColorDrawFormat() {
        valueMap = new HashMap<>();
    }

    public TextWithColorDrawFormat(int[] color) {
        valueMap = new HashMap<>();
        this.color = color;
        setColor = true;
    }

    public TextWithColorDrawFormat(int[] color,String[][] status) {
        valueMap = new HashMap<>();
        this.color = color;
        setColor = true;
        mStatus = status;
    ...
    public TextWithColorDrawFormat(int width, int[] color) {
        valueMap = new HashMap<>();
        this.color = color;
        setColor = true;
        mWidth = width;
    ...
    public TextWithColorDrawFormat(int width, int[] color, String[][] status) {
        valueMap = new HashMap<>();
        this.color = color;
        setColor = true;
        mWidth = width;
    ...
    protected void drawText(Canvas c, String value, Rect rect, Paint paint, CellInfo<T> cellInfo) {
        if (setColor)
            DrawUtils.drawMultiTextWithColor(c, paint, rect, getSplitString(value), color, cellInfo, mStatus);
        else
