...
public class Column<T> implements Comparable<Column> {
    ...
    private boolean isFixedWidth;//是否是固定宽度
    private int fixedWidth;
    private boolean isShowColumnTitleVerticalLine = false;
    ...
    public boolean isShowColumnTitleVerticalLine() {
        return isShowColumnTitleVerticalLine;
    }

    public void setShowColumnTitleVerticalLine(boolean showColumnTitleVerticalLine) {
        isShowColumnTitleVerticalLine = showColumnTitleVerticalLine;
    }
    ...
    /**
     * 设置点击列监听
     * @param onColumnItemClickListener  列监听
     */
