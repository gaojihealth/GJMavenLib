...
public class FontStyle implements IStyle {
     ...
     * @param defaultTextSize 默认字体大小
     */
    public static void setDefaultDpTextSize(Context context, int defaultTextSize) {
        defaultFontSize = DensityUtils.dp2px(context, defaultTextSize);
    }
    ...
    public FontStyle setDpTextSize(Context context,int textSize) {
        this.textSize = DensityUtils.dp2px(context,textSize);
        return this;
    }
