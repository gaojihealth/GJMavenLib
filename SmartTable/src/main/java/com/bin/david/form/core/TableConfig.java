...
public class TableConfig {
    ...
    private int[] tableTitleBgColors;
    ...
    public void setTableTitleBgColors(int[] colors){
        tableTitleBgColors = colors;
    }

    public int[] getTableTitleBgColors(){
        return tableTitleBgColors;
    }
