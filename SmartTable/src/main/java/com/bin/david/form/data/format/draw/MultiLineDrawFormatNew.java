...
public class MultiLineDrawFormatNew<T> extends TextDrawFormat<T> {
     ...
     * @param width 指定宽度 px
     */
    public MultiLineDrawFormatNew(int width) {
        this.width = width;
    }
     ...
     * @param width 指定宽度 px
     */
    public MultiLineDrawFormatNew(int width, int color, List<Integer> datas) {
        this.width = width;
        this.color = color;
        this.mDatas = datas;
    }
     ...
     * @param width 指定宽度 px
     */
    public MultiLineDrawFormatNew(int width, int color, List<Integer> datas, int leftPadding) {
        this.width = width;
        this.color = color;
        this.mDatas = datas;
     ...
     * @param width 指定宽度 px
     */
    public MultiLineDrawFormatNew(int width, int color, List<Integer> datas, int leftPadding, boolean singleLeft) {
        this.width = width;
        this.color = color;
        this.mDatas = datas;
        this.mLeftPadding = leftPadding;
     ...
     * @param width 指定宽度 px
     */
    public MultiLineDrawFormatNew(int width, int color, int leftPadding) {
        this.width = width;
        this.color = color;
        this.mLeftPadding = leftPadding;
    }
     ...
     * @param width 指定宽度 px
     */
    public MultiLineDrawFormatNew(int width, int color) {
        this.width = width;
        this.color = color;
    }
     ...
     */
    public MultiLineDrawFormatNew(Context context, int dpWidth) {
     ...
     * @param dpWidth 指定宽度 dp
     */
    public MultiLineDrawFormatNew(Context context, int dpWidth, int color, List<Integer> datas) {
        this.width = DensityUtils.dp2px(context, dpWidth);
        this.color = color;
        this.mDatas = datas;
    }
